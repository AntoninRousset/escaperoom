...
#corridor = eg.Device(name='corridor')
#number = eg.Attribute(corridor, name='number')
#corridor.add_attr(number)
#network.add_device(corridor)
...
#start.add_condition(number)
#start.predicate = lambda: number.value > 66
